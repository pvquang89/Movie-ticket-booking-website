...
public partial class DbCinemasContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        => optionsBuilder.UseSqlServer("Data Source=PVQUANG1989\\PVQUANG;Initial Catalog=dbCinemas;Integrated Security=True;Encrypt=True;Trust Server Certificate=True");
